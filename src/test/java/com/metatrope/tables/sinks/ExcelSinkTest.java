...
import com.metatrope.tables.sources.ExcelSource;
...
public class ExcelSinkTest {
    ...
    public void testRoundTrip() throws Exception {
        ...
        byte[] data = Etl.source(listImporter).sink(new ExcelSink("test")).asByteArray();
        String csv = Etl.source(new ExcelSource(data)).sink(new CsvSink()).asString();
